...
if(isset($_POST['login']))
{
    ...
    if(empty($username) || empty($password)){
        ...
        $sql1 = $db->query("SELECT * FROM staff WHERE username='$username'");

        // Check to ensure that ensure that the username and the passwords match.
        $sql2 = $db->query("SELECT * FROM staff WHERE username='$username' AND password='$password'");
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="#"><b>Departmental Head Login Form</b></a>
            </div>
